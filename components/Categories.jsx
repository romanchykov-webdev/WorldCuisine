...
function Categories({ categories, activeCategory, setActiveCategory, handleChangeCategory, langApp }) {
    ...
    >
      {
        categories.length > 0 && categories?.map((category, index) => {
          ...
          const isActiveCategory = isActive ? 'bg-amber-400' : 'bg-black/10'
          ...
          return (
            ...
            >
              ...
              >
                ...
                <Text
                  style={[{ width: 70, fontSize: 10 }, shadowText({
