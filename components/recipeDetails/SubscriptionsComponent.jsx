      ...
      { text: i18n.t('Cancel'), style: 'cancel' },
      {
        ...
        onPress: () =>
          router.push({
            ...
            params: { recipeDish: JSON.stringify(recipeDish), isRefactorRecipe: 'true' },
          }),
      },
    ])
  }
    ...
    >
      ...
      >
        <View style={shadowBoxBlack()} className="items-center relative">
          <AvatarCustom size={hp(allRecipeBayCreatore ? 20 : 10)} uri={creator?.creatorAvatar} />
        </View>
      ...
      {isSelf ? (
        <View className={`${allRecipeBayCreatore ? 'items-center flex-1' : 'flex-1 m-w-[50%]'}`}>
