...
import { PlayCircleIcon } from 'react-native-heroicons/solid'; // если есть иконка play
...
function RecipePointItemComponent({ item, index, langApp }) {
    ...
    const categoryTitle =
        item.title?.[langApp] || item.title?.en || item.title[0];
            ...
            >
                ...
                <View
                    style={[
                        styles.topInfo,
                        item?.video
                            ? styles.topInfoWithVideo
                            : styles.topInfoNoVideo,
                        shadowBoxBlack({
                            offset: { width: 1, height: 1 },
                            opacity: 1,
                            radius: 1,
                ...
                <View style={styles.bottomBlock}>
                    <Text style={[styles.categoryTitle, shadowText()]}>
                        {categoryTitle}
                    </Text>
