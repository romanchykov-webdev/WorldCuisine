 ...
 * @param {number} [maxImages=5] - Максимальное количество изображений, которое можно добавить
 ...
 * @param {number} [compress=0.3] - Степень сжатия изображения (от 0 до 1)
 ...
 * @param {number} [maxImages=5] - Максимальное количество изображений
