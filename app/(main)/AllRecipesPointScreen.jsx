...
import { AdjustmentsVerticalIcon, ArrowDownIcon, ArrowUpIcon, HeartIcon, StarIcon } from 'react-native-heroicons/mini'
...
function AllRecipesPointScreen({
  ...
  const getSortOptions = () => {
    ...
    if (filters.oldNew)
      return { sortBy: 'created_at', ascending: true }
    if (filters.likes)
      return { sortBy: 'likes', ascending: false }
    if (filters.rating)
      return { sortBy: 'rating', ascending: false }
