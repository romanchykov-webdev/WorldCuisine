...
import MapСordinatesComponent from '../components/recipeDetails/MapCoordinatesComponent';
            ...
            {loading || recipeDish === null ? (
                ...
                <View className="gap-y-5" key={id}>
                        ...
                        >
                            ...
                            <View className="flex items-center py-2 gap-y-1">
                              ...
                              "
                                >
                                    {i18n.t(
                                        `${recipeDish?.recipe_metrics?.level}`
                                    )}
                                </Text>
                            </View>
                        </View>
                    ...
                    {recipeDish?.link_copyright && (
                        <View className="mb-5">
                            <LinkCopyrightComponent
                                linkCopyright={recipeDish?.link_copyright}
                            />
                        </View>
                    )}
                    ...
                    {recipeDish?.map_coordinates && (
                        <View className="mb-5">
                            <MapCoordinatesComponent
                                mapLink={recipeDish?.map_coordinates}
                            />
                        </View>
                    )}
                    ...
                    {(recipeDish?.social_links.facebook ||
                        ...
                        <View className="mb-5 mt-5">
                            ...
                            <SocialLinksComponent
                                socialLinks={recipeDish?.social_links}
                            />
                        </View>
                    )}
                    {/*    accordion comments*/}
