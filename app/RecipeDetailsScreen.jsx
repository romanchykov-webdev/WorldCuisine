							...
							>
								...
								<View className="flex-row justify-center items-center relative" style={shadowBoxBlack()}>
									...
									>
										...
										<ButtonLike isPreview={isPreview} user={user ?? null} recipeId={recipeDish?.id} />
									</Animated.View>
									...
									>
										...
										>
											<TouchableOpacity className="items-center justify-center flex-row" onPress={scrollToComments}>
								...
								<Animated.View entering={FadeInDown.delay(570)}>
									<SelectLangComponent recipeDishArea={recipeDish?.area} handleLangChange={handleLangChange} langApp={langApp} />
								</Animated.View>
								...
								<Animated.View entering={FadeInDown.delay(600)} className="px-4 flex justify-between gap-y-5 ">
									...
									<View className="gap-y-2">
										<Text style={[{ fontSize: hp(2.7) }, shadowTextSmall()]} className="font-bold  text-neutral-700">
											{/*{recipeDish?.strMeal}*/}
											{recipeDish?.title?.lang.find((item) => item.lang === langApp)?.name || recipeDish?.title?.strTitle}
										</Text>
								...
								<Animated.View entering={FadeInDown.delay(800)} className="gap-y-4 ">
									<Text style={[{ fontSize: hp(2.5) }, shadowTextSmall()]} className="font-bold px-4 text-neutral-700">
										{i18n.t("Ingredients")}
									</Text>
								...
								{/*    instructions*/}
								<Animated.View entering={FadeInDown.delay(800)} className="gap-y-4 ">
									<RecipeInstructions isPreview={isPreview} instructions={recipeDish?.instructions} langDev={langApp} />
								...
								{/*    recipe video*/}
								<View className="mb-5">{(recipeDish?.video?.strYoutube !== null || recipeDish?.video?.strYouVideo !== null) && <VideoCustom video={recipeDish?.video} />}</View>
								{/*    recipe video end*/}
